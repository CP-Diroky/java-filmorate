-- Используем команду MERGE вместо INSERT чтобы избежать дублирований
-- Так как в ТЗ не предусмотрены методы PUT для таблиц mpa и genres, были созданы свои жанры и рейтинги
